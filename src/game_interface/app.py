...
from src.ai.model_wrapper import StateEvaluator
...
@app.post(
    ...
    tags=["Game State"],
    summary="Получить вероятности действий и ID лучшего хода для определенной карты",
    description="Возвращает вероятности всех возможных действий и ID действия с наибольшей вероятностью для заданного состояния игры для определенной карты map_basic_small.json",
)
